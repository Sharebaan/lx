...
<div class="col-md-12">
						<fieldset><legend> Admin Geographies Temp</legend>
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {!! Form::text('id_parent', $row['id_parent'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
									 </div> 
									 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('admingeographiestemp?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
