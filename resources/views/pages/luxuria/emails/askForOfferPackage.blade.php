                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td align="center">
                                                <div class="imgpop">
                                                   <a target="" href="#">
                                                   <center><img src="{{url('sximo/themes/luxuria/images/210x140.png')}}" alt="" border="0"  style="display:block; border:none; outline:none; text-decoration:none;"></center>
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;">
                                                ...
                                                <table class="gridtable" width="100%">
                                                   ...
                                                   <tr>
                                                      <th width="35%">Pret estimativ</th>
                                                      <td style="color:red !important;">&euro; {{{$askForOffer->price}}}</td>
                                                   </tr>
               											</table>
                                             </td>
                                          </tr>
                                          ...
                                          <tr>
                                             ...
                                             <td width="174" height="40" align="left">
                                                <div class="imgpop">
                                                   ...
                                                   <img src="{{url('sximo/themes/luxuria/images/210x140.png')}}" alt="" border="0"  height="21" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td width="22" height="22" align="right">
                                                <div class="imgpop">
                                                   <a target="" href="">
                                                   <img src="http://luxuria.infora.ro/images/fb.png" alt="" border="0" width="22" height="22" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
