...
<section class="packages hotelsblade">
	<div class="container">
		<div class="row">
			<!-- START LEFT FILTERS -->
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3" id="column_filters">
					...
					<div class="ba-item-view-search clearfix home_search_box">
				      ...
				      <div class="ba-item-view-search-in clearfix">
				          ...
				          <div class="ba-search-departure-date input-hotel">
				            <div class="ba-search-selector-div">
				              <input type="text" id="searchDepartureDateHotel" value="* Checkin" class="datepicker ba-search-selector" readonly/>
				            </div>
				          </div>
				          <div class="ba-search-return-date input-hotel">
				            <div class="ba-search-selector-div">
				              <input type="text" id="searchArrivalDateHotel" value="* Checkout" class="datepicker ba-search-selector" readonly/>
				            </div>
				          </div>
					...
					<div class="box_filter">
						<div class="box_filter_title">Filtreaza rezultatele {{($page-1) * 10 + 1}} -  {{( (int) ($noHotels/10 + 1) == $page) ? $noHotels : ($page * 10)}} din {{$noHotels}} oferte</div>
					...
					@if($searchId == 0)
					<div class="box_filter">
						<div class="box_filter_title">Tip transport</div>
					...
					@endif
					<div class="box_filter">
						<div class="box_filter_title">Tip masa</div>
