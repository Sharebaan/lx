...
<section class="packages circuitsblade">
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3" id="column_filters">
					...
					<div class="box_filter">
						...
						<div class="ba-filter-box clearfix">
							<div class="ba-filter-box-content collapse in" id="price-div">
								...
								<br/>
								<a id="price-filter-button" class="yellow_big_btn" title="" href="#">Filtreaza</a>
							</div>
						</div>
						<div class="clear"></div>
					</div>
					...
					<div class="box_filter">
						...
						<div class="box_filter_inside">
							<div class="ba-filter-box-content collapse in" id="offer-type-div">
