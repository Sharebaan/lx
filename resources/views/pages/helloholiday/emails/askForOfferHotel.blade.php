                                    ...
                                    <table align="center" border="0" cellpadding="0" cellspacing="0">
                                       <tbody>
                                          <tr>
                                             ...
                                             <td align="center">
                                                <div class="imgpop">
                                                   <a target="http://europatravel.ro" href="#">
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;">
                                                O noua cerere de oferta pentru {{{$askForOffer->hotel->name}}} a fost creata.
                                                <br/>
                                                <br/>
                                                <table class="gridtable" width="100%">
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>{{{$soapClientName}}}</td>
               												...
               												<tr>
               													<th width="35%">Id Hotel</th>
               													<td>{{{$askForOffer->id_hotel}}}</td>
               												</tr>
                                                   <tr>
                                                      <th width="35%">Nume Hotel</th>
                                                      <td>{{{$askForOffer->hotel->name}}}</td>
                                                   </tr>
                                                   <tr>
                                                      <th width="35%">Locatie</th>
                                                      <td>{{{$askForOffer->hotel->getFormatedLocationMin()}}}</td>
                                                   </tr>
                                                   <tr>
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td width="174" height="40" align="left">
                                                <div class="imgpop">
                                                   <a target="_blank" href="http://hello2.infora.ro">
