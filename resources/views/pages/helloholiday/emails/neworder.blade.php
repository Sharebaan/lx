                           ...
                           <tbody>
                              ...
                              <tr>
                                 <td>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;">
                                                ...
                                                O noua rezervare a fost facuta.
												...
												@if(!empty($bookingInput['company-name']))
												<tr>
                                    ...
                                    <?php
                                          $day='';
                                         $d = \DB::table('packages')->where('idx','=',json_decode($bookingInput['bookingpack'])->id_package)->first();
                                         if(!empty($d)){
                                             $day = $d;
                                          }else{
                                             $day = new \stdClass();
                                    ...
                                    <tr>
                                       ...
                                       @endif
                                        ...
                                        {{json_decode($bookingInput['bookingpack'])->price}}</td>
												</tr>
												</table>
                                             </td>
                                          </tr>
