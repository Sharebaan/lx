                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td align="center">
                                                <div class="imgpop">
                                                   <a target="" href="#">
                                                   <center><img src="{{url('sximo/themes/helloholiday/images/210x140.jpg')}}" alt="" border="0"  style="display:block; border:none; outline:none; text-decoration:none;"></center>
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                           ...
                           <tbody>
                              ...
                              <tr>
                                 <td>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;">
                                                @if($bookingInput['paytype'] == "Romcard")
                                                Multumim pentru rezervarea facuta. Plata este in procesare. Veti fi informati cand plata s-a realizat. Mai jos aveti detaliile rezervarii :
                                                @elseif($bookingInput['paytype'] == "Offer")
                                                <p>Va multumim pentru solicitarea dumneavoastra. Sunteti cu un pas mai aproape de vacanta. Pentru a efectua o rezervare ferma si a bloca locurile, este necesara achitarea unui avans. Doar la momentul platii, se re-verifica disponibilitatea locurilor si se poate face o rezervare ferma.</p><br>
                                                <p>Daca doriti sa cumparati vacanta pe loc, va rugam sa alegeti optiunea de plata online.</p><br>
                                                <p>Mai jos aveti detaliile rezervarii:</p>
                                                @else
                                                Multumim pentru rezervarea facuta. Rezervarea este valabila 24 de ore de la crearea ei, timp in care trebuie sa efectuati plata. Mai jos aveti detaliile rezervarii :
                                                @endif
												...
												@if(!empty($bookingInput['company-address']))
												<tr>
												...
												<tr>
													...
													<td style="color:red !important;">
														@if($bookingInput['paytype'] == "Romcard")
															Online 
                                          @elseif($bookingInput['paytype'] == "OP")
                                             Ordin de plata   
														@else
															La sediu
														@endif
                                    ...
                                    <tr>
                                       <th width="35%">Name</th>
                                       <td>{{\DB::table('hotels')->where('id','=',json_decode($bookingInput['bookingpack'])->id_hotel)->first()->name}}</td>
                                    </tr>
                                    <tr>
                                       <th width="35%">Check In</th>
                                       <td>{{json_decode($bookingInput['bookingpack'])->check_in}}</td>
                                    </tr>
                                     <tr>
                                       <th width="35%">Check Out</th>
                                       <td>{{json_decode($bookingInput['bookingpack'])->check_out}}</td>
                                    </tr>
                                    <tr>
                                       <th width="35%">Durata</th>
                                       <td>{{json_decode($bookingInput['bookingpack'])->duration}}  {{json_decode($bookingInput['bookingpack'])->duration == 1 ? "zi" : "zile"}}</td>
                                    </tr>
                                     <tr>
                                       <th width="35%">Camere</th>
                                       <td>{{count(json_decode(json_decode($bookingInput['bookingpack'])->rooms))}} x {{json_decode($bookingInput['bookingpack'])->room_category}} pentru {{json_decode(json_decode($bookingInput['bookingpack'])->rooms)[0]->Adults == 1? "1 Adult":json_decode(json_decode($bookingInput['bookingpack'])->rooms)[0]->Adults." Adulti"}} {{json_decode(json_decode($bookingInput['bookingpack'])->rooms)[0]->ChildAges == 0?"":(json_decode(json_decode($bookingInput['bookingpack'])->rooms)[0]->ChildAges == 1?"si 1 Copil":"si ".json_decode(json_decode($bookingInput['bookingpack'])->rooms)[0]->ChildAges." Copii")}}</td>
                                    </tr>
                                    <tr>
                                       <th width="35%">Tipul camerei</th>
                                       <td>Tipul {{count(json_decode(json_decode($bookingInput['bookingpack'])->rooms))== 1 ?"camerei: ":"camerelor: "}}{{json_decode($bookingInput['bookingpack'])->room_category}}</td>
                                    </tr>
                                     <tr>
                                       <th width="35%">Tipul mesei</th>
                                       <td>{{json_decode($bookingInput['bookingpack'])->meal_plan}}</td>
                                    </tr>
                                    <tr>
                                       <th width="35%">Tip transport</th>
                                       <td>
                                       @if(json_decode($bookingInput['bookingpack'])->is_flight == 1)
                                          Avion
                                       @elseif(json_decode($bookingInput['bookingpack'])->is_bus == 1)
                                          Autocar
                                       @else
                                          Individual
                                       @endif
												...
												<tr>
													...
													<td style="color:red !important;">
                                       @if(isset($bookingInput['payment-type']))
                                          @if($bookingInput['payment-type'] == "EUR")
                                          &euro;   
                                          @else
                                          RON
                                          @endif
                                          ...
                                          <tr>
                                             ...
                                             <td width="174" height="40" align="left">
                                                <div class="imgpop">
                                                   ...
                                                   <img src="{{url('sximo/themes/helloholiday/images/210x140.jpg')}}" alt="" border="0"  height="21" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td width="22" height="22" align="right">
                                                <div class="imgpop">
                                                   <a target="_blank" href="">
                                                   <img src="{{url('sximo/themes/helloholiday/images/210x140.jpg')}}" alt="" border="0" width="22" height="22" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
