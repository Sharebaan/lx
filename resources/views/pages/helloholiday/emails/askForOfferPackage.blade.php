                                    ...
                                    <table align="center" border="0" cellpadding="0" cellspacing="0">
                                       <tbody>
                                          <tr>
                                             ...
                                             <td align="center">
                                                <div class="imgpop">
                                                   <a target="http://veratravek.ro" href="#">
                                       ...
                                       <tbody>
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #2d2a26; text-align:left; line-height: 24px;">
                                                Cererea de oferta #{{{$askForOffer->id}}}
                                             </td>
                                          </tr>
                                          <!-- Spacing -->
                                          <tr>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;">
                                                O noua cerere de oferta pentru {{{$askForOffer->package->name}}} a fost creata.
                                                <br/>
                                                <br/>
                                                <table class="gridtable" width="100%">
               												<tr>
               													<th width="35%">Numar cerere</th>
               													<td>{{{$askForOffer->id}}}</td>
               												</tr>
               												<tr>
               													<th width="35%">Nume</th>
               													<td>{{{$contactInput['lname']}}}</td>
               												</tr>
               												<tr>
               													<th width="35%">Prenume</th>
               													<td>{{{$contactInput['fname']}}}</td>
               												</tr>
               												<tr>
               													<th width="35%">Adresa de email</th>
               													<td>{{{$contactInput['email']}}}</td>
               												</tr>
               												<tr>
               													<th width="35%">Telefon</th>
               													<td>{{{$contactInput['phone']}}}</td>
               												</tr>
                                                   <tr>
                                                      <th width="35%">Mesaj aditional</th>
                                                      <td>{{{$contactInput['message']}}}</td>
                                                   </tr>
                                                   <tr>
                                                      <th width="35%">Furnizor</th>
                                                      <td>{{{$soapClientName}}}</td>
                                                   </tr>
               												<tr>
               													<th width="35%">Id Pachet</th>
               													<td>{{{$askForOffer->id_package}}}</td>
               												</tr>
                                                   <tr>
                                                      <th width="35%">Nume Pachet</th>
                                                      <td>{{{$askForOffer->package->name}}}</td>
                                                   </tr>
                                                   <tr>
                                                      <th width="35%">Locatie</th>
                                                      <td>{{{$askForOffer->package->hotel->getFormatedLocationMin()}}}</td>
                                                   </tr>
                                                   <tr>
                                                      <th width="35%">Check In</th>
                                                      <td>{{{$askForOffer->departure_date}}}</td>
                                                   </tr>
                                                   <tr>
                                                      <th width="35%">Check Out</th>
                                                      <td>{{{$askForOffer->return_date}}}</td>
                                                   </tr>
                                                   <tr>
                                                      <th width="35%">Durata</th>
                                                      <td>{{{$askForOffer->duration}}}</td>
                                                   </tr>
                                                   <tr>
                                                      <th width="35%">Camere</th>
                                                      <td>{{{$noRooms}}} x {{{$askForOffer->room_category}}} pentru {{{$noAdults == 1 ? "1 Adult" : $noAdults. " Adulti"}}} {{{$noKids == 0 ? "" : ($noKids == 1 ? "si 1 Copil" : "si ".$noKids." Copii")}}}</td>
                                                   </tr>
                                                   <tr>
                                                      <th width="35%">Tipul Camerei</th>
                                                      <td>{{{$askForOffer->room_category}}}</td>
                                                   </tr>
                                                   <tr>
                                                      <th width="35%">Tipul Mesei</th>
                                                      <td>{{{$askForOffer->meal_plan}}}</td>
                                                   </tr>
                                                   <tr>
                                                   ...
                                                   <tr>
                                                      <th width="35%">Data creare oferta</th>
                                                      <td>{{{$askForOffer->created_at}}}</td>
                                                   </tr>
                                                   <tr>
                                                      <th width="35%">Pret</th>
                                                      <td style="color:red !important;">@if($askForOffer->currency == 0) &euro; @else LEI @endif {{{$askForOffer->price}}}</td>
                                                   </tr>
               											</table>
                                             </td>
                                          </tr>
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td width="174" height="40" align="left">
                                                <div class="imgpop">
                                                   <a target="_blank" href="hello2.infora.ro">
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td width="22" height="22" align="right">
                                                <div class="imgpop">
                                                   <a target="_blank" href="https://www.facebook.com/agentia.helloholidays">
