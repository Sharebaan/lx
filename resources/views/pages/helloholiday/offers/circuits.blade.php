...
<script type="text/javascript">
	$(document).ready(function(){
      	...
      	$('#guests1').roomify(<?php echo $jsonRooms; ?>);
      	$('#guests2').roomify(<?php echo $jsonRooms; ?>);
      	$('#guests3').roomify(<?php echo $jsonRooms; ?>);
			@else
...
<div id="main" class="pages circuitsblade">
    <div class="inner">
     ...
     <div class="content-padding">
			...
			<div class="country_filter_content mobile-hidden-country">
					<ul class="ba-filter-options-2" id="country_filter" style="display: block;">
						@foreach($locations["data"] as $location)
							<li class="box-25 <?php if(isset($location->selected) && $location->selected) echo 'active'; ?>">
        ...
        @foreach($packages as $package)
          ...
          <div class="listing-box-details box-75 listing-row-height">
              ...
              <div class="row-inner">
                  <h1 class="box-title"><a href="{{$link}}">{{$package->name}}</a><span>{{App\Models\Travel\Geography::getFormatedLocation($package->location)}}</span></h1>
