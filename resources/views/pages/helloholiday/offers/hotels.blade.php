  ...
  <div class="inner">
    ...
    <section class="search desktop overflow_visible"><div id="aside-search-module">
        ...
        <div class="tabs">
            ...
            <li id="hotelsTabActivator" class="active"><a href="#tab3">Hoteluri</a></li>
            </ul>
            ...
            <div id="tab3" class="tab active">
                <h4 class="text-center">Caută hotelul dorit</h4>
								...
								<div class="search_section">
									<div class="selector">
										<label>Checkin</label>
										<input type="text" id="searchDepartureDateHotel" value="{{$searchObj->checkIn}}" class="datepicker" readonly/>
									</div>
								</div>
								...
								<div class="search_section">
									<div class="selector">
										...
										<input type="text" id="searchArrivalDateHotel" value="{{$searchObj->checkOut}}" class="datepicker" readonly/>
									</div>
								</div>
    	...
    	<div class="filters-container">
            ...
            <ul class="filters-option">
            	@foreach ($mealPlans as $mealPlan)
            				<li><a href="{{{$mealPlan->url}}}" <?php if($mealPlan->selected) echo 'class="filter_active"'; ?>>{{{strtoupper(str_replace("_"," ",$mealPlan->name))}}}</a></li>
		        @endforeach
			 </ul>
            </div>
