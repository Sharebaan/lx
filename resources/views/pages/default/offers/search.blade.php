...
<section class="packages">
	...
	<div class="nicdark_container nicdark_vc nicdark_clearfix">
				      ...
				      <div class="ba-item-view-search-in clearfix">
				          <div class="ba-search-transport-type input-others">
				            <div class="ba-search-selector-div">
				              <select id="searchTransportType" class="ba-search-selector sbar">
				          ...
				          <div class="ba-search-departure-point input-others">
				            <div class="ba-search-selector-div">
				              <select id="searchDeparturePoint" class="ba-search-selector sbar">
				          ...
				          <div class="ba-search-country-destination">
				            <div class="ba-search-selector-div">
				              <select id="searchCountryDestination" class="ba-search-selector sbar">
				          ...
				          <div class="ba-search-city-destination">
				            <div class="ba-search-selector-div">
				              <select id="searchCityDestination" class="ba-search-selector sbar">
				          ...
				          <div class="ba-search-departure-date input-others">
				            <div class="ba-search-selector-div">
				              <select id="searchDepartureDate" class="ba-search-selector sbar">
				          ...
				          <div class="ba-search-duration input-others">
				            <div class="ba-search-selector-div">
				              <select id="searchDuration" class="ba-search-selector sbar">
        ...
        @endif */?>
					<div class="box_filter">
						<div class="box_filter_title">
							...
							<span class=""><span class="ba-color-blue"></span> din <span class="ba-color-blue"></span> oferte</span>
						</div>
						<div class="ba-filter-box clearfix">
							...
							<!-- PRET SLIDER -->
							<!-- <div class="nicdark_margintop20 nicdark_bg_grey2 nicdark_slider_range nicdark_slider_range_green nicdark_focus ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" aria-disabled="false">
							...
							<input type="hidden" name="nicdark_price_from" value=" 1000 ">
							<input type="hidden" name="nicdark_price_to" value=" 9000"> -->
							<!-- END PRET SLIDER -->
					...
					<div class="box_filter">
						...
						<div class="box_filter_inside">
							...
							<?php /*	@foreach ($fareTypes as $fareType)
      ...
      <?php /*  @for($i = 1; $i <= 5; $i++)
				<a class="ba-filter-option-a" href="/search/search=".{{$searched}}."&page=".{{$page}}>
			            ...
			            <div id="custom-search-input">
			                <div class="input-group col-md-12">
													<form class="" action="/search" method="get">
														<input type="text" name="search" class="form-control input-lg" id="searchbar" placeholder="Cauta" />
													</form>
			                </div>
			            </div>
							...
							select:function(a,b){
								$.each(all,function(i,v){
									if(v.name === b.item.value){
										//$.get('/ajax_search/search_select/',{id:v.id});
						...
						<div class="nicdark_focus nicdark_bg_red nicdark_relative">
							...
							<div class="nicdark_width100_responsive nicdark_width_percentage50 nicdark_focus nicdark_bg_white nicdark_border_grey nicdark_sizing list_text">
								<div class="nicdark_textevidence nicdark_bg_grey nicdark_borderbottom_grey">
									...
									<h4 class="grey nicdark_margin20 list_title"><a style="color: #1671ff !important;font-size: 20px !important;" href="{{$link}}">{{$package->hotel_name}}</a><br /><p> @for($i = 0;  $i < $package->stars; $i++)<img src="/images/star.png" />@endfor</p></h4>
							...
							<div class="nicdark_displaynone_responsive nicdark_width_percentage20 nicdark_height100percentage nicdark_absolute_floatnone right">
								<div class="nicdark_filter nicdark_display_table nicdark_height100percentage center">
									...
									<div class="nicdark_cell nicdark_vertical_middle">
						    			...
						    			<h1 class="white">{{(int)$package->min_price}}
												@if(isset($package->currency))
												@if( $package->currency == 0)
													€
												@else
													RON
												@endif</h1>
        ...
        @foreach($hotels as $hotel)
			        ...
			        $transport = App\Models\Travel\PackageInfo::getTransportCode(0,0,0);
			        $link = "/oferte/".$pageTitle.'/'.$location.'/'.str_replace("/","-",str_replace(" ", "-", str_replace("_","-",$hotel->name)))."_".$transport."_".$hotel->id."_".$hotel->soap_client."_sid0";
			    ?>
				<!-- START ITEM -->
				<div style="position: relative;" class="nicdark_masonry_container">
					<div class="grid grid_12 percentage nicdark_masonry_item nicdark_sizing trip_item">
						...
						<div class="nicdark_focus nicdark_bg_red nicdark_relative">
							...
							<div class="nicdark_focus nicdark_displaynone_desktop nicdark_displayblock_iphonepotr nicdark_displayblock_iphoneland nicdark_displayblock_ipadpotr nicdark_displayblock_ipadland">
								...
								<div class="nicdark_focus nicdark_relative nicdark_fadeinout nicdark_overflow">
									...
									<img alt="" class="nicdark_focus nicdark_zoom_image" src="{{App\Models\Travel\Hotel::getBasePhotoLinkFor($hotel->id,$hotel->soap_client)}}">

									<!--price-->
									<div class="nicdark_fadeout nicdark_absolute nicdark_height100percentage nicdark_width_percentage100">
										<a href="" class="nicdark_btn nicdark_bg_red left white medium">€</a>
									</div>
									<!--end price-->
							...
							<div class="nicdark_width100_responsive nicdark_width_percentage50 nicdark_focus nicdark_bg_white nicdark_border_grey nicdark_sizing list_text">
								<div class="nicdark_textevidence nicdark_bg_grey nicdark_borderbottom_grey">
									...
									<h4 class="grey nicdark_margin20 list_title"><a style="color: #1671ff !important;font-size: 20px !important;" href="{{$link}}">{{$hotel->name}}</a><br /><p> @for($i = 0;  $i < $hotel->class; $i++)<img src="/images/star.png" />@endfor</p></h4>
									<p class="simple_trip_row">{{$hotel->address}}</p>
				...
				<div class="pag_bottom">
					<div classs="five columns alpha">
            {!!$hotels->appends(['search'=>$searched])->render()!!}
