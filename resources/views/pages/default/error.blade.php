        ...
        <section id="content">
            <div class="container">
                <div id="main">
                    ...
                    <div class="col-md-5"></div><div class="col-md-2"><center><br/><a class="button btn-small full-width text-center" href="{{{$errorUrl}}}">Inapoi</a></center></div>
                </div>
            </div>
        </section>
