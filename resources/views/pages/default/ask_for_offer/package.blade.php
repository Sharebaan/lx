      ...
      <div class="ba-order-left two-thirds column ba-column-no-margin-left vc_col-sm-8">
      	<div id="main">
	        ...
	        <div class="ba-order-payment-details">
	          ...
	          <center><button class="ba-blue-button-m" id="contact-button" title="">Trimite</button></center>
	        </div>
	        </form>
        </div>
        <div id="thankyou-div" style="display: none;">
            ...
            <div class="ba-thankyou-button" style="width: 300px">
      ...
      <div class="ba-order-right one-third column ba-column-no-margin-right vc_col-sm-4" style="margin-bottom: 40px;">
        <div class="ba-order-details">
          ...
          <div class="ba-order-details-content">
            ...
            <p class="ba-order-details-hotel-name">{{{$askForOffer->package->name}}}</p>
            <p class="ba-order-details-hotel-location simple_trip_row"><i class="fa fa-map-marker"></i> {{{$askForOffer->package->hotel->getFormatedLocationMin()}}}</p>
