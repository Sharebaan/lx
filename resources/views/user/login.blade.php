...
<div class="sbox ">
	...
	<div class="text-center  animated fadeInDown delayp1">
		<img src="{{ asset('images/logo_mini.jpg')}}" width="160" height="70" />
	</div>
	...
	<ul class="nav nav-tabs" >
	  <li class="active"><a href="#tab-sign-in" data-toggle="tab">  {{ Lang::get('core.signin') }} </a></li>
	   ...
	   @if(CNF_REGIST =='true')
	   <li style="display:none;"><a href="{{ URL::TO('user/register')}}" >  {{ Lang::get('core.signup') }} </a></li>
	   @endif
	...
	<div class="tab-content" >
		...
		<form method="post" action="{{ url('user/signin')}}" class="form-vertical">
			...
			<div class="form-group has-feedback  animated fadeInRight delayp1">
				...
				<i class="icon-lock form-control-feedback"style="display:none;"></i>
			</div>
			...
			@if(CNF_MULTILANG =='1')
			<div class="form-group has-feedback  animated fadeInLeft delayp1" style="display:none;">
