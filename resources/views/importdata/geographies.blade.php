						...
						<div class="col-xs-12">
							...
							<div class="col-md-12 well text-center">
								<div class="form-group">
										{!! Form::open(array('url'=>'importdata/importgeographies/one', 'enctype'=> 'multipart/form-data', 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
										<div class="col-md-10">
					...
					<div class="row setup-content" id="step-2">
						<div class="col-xs-12">
							...
							<div class="col-md-12 well">
								{!! Form::open(array('url'=>'importdata/importgeographies/two', 'enctype'=> 'multipart/form-data', 'class'=>'form-horizontal' ,'id' =>'SximoTable','novalidate' => '' )) !!}
								@if($step == 'one')
									<?php 
